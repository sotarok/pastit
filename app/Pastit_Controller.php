<?php
/**
 *  Pastit_Controller.php
 *
 *  @author     {$author}
 *  @package    Pastit
 *  @version    $Id: 530701468ce0134163e7478728ccd3bf6622a85a $
 */
...
require_once 'Pastit_Error.php';
require_once 'Pastit_ActionClass.php';
 ...
 *  @package    Pastit
 */
class Pastit_Controller extends Ethna_Controller
{
    /**#@+
     *  @access protected
     */
    ...
    public $class = array(
        ...
        'form'          => 'Pastit_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'sql'           => 'Ethna_AppSQL',
        'view'          => 'Pastit_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty3',
        'url_handler'   => 'Pastit_UrlHandler',
    );
